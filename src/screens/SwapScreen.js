import { Image, PermissionsAndroid, Platform, StyleSheet, Text, TouchableOpacity, View, ScrollView, TextInput, Modal, } from 'react-native'
...
import BatteryComponent from '../assets/images/Battery';
                                    ...
                                    <View style={globalStyles.mainHomeView}>
                                        <ScrollView contentContainerStyle={globalStyles.homeScrollView} showsVerticalScrollIndicator={false}>
                                            ...
                                            <View style={globalStyles.bookSlotView}>
                                                <TouchableOpacity style={globalStyles.bookSlotBtn} onPress={() => setSelected('BookBatteryOne')}>
                                                    <Text style={globalStyles.bookSlotText}>Book Battery</Text>
                                                </TouchableOpacity>
                                                <TouchableOpacity style={globalStyles.startBtn} onPress={() => setSelected('DirectMe')}>
                                                    <StartComponent size={Height(15)} />
                                                    <Text style={[globalStyles.bookSlotText, { marginLeft: Width(8) }]}>Direct Me</Text>
                                                </TouchableOpacity>
                                            </View>
                                            <View style={globalStyles.lineView} />
                                            <View style={globalStyles.electricMainView}>
                                                ...
                                                <DropShadow
                                                    style={globalStyles.shadowView}
                                                >
                                                    <View style={styles.electricBtn}>
                                                        <BatteryComponent width={Width(21)} height={Height(14)} />
                                                        <Text style={globalStyles.electricText}>₹750 to ₹3550</Text>
                                                        <Ionicons name='information-circle-outline' style={{ marginLeft: Width(20) }} size={Height(15)} />
                                                    </View>
                                                </DropShadow>
                                            </View>
                                            <View style={globalStyles.lineView} />
                                                        ...
                                                        return (
                                                            <View key={i}>
                                                                <View style={globalStyles.mainView}>
                                                                    ...
                                                                    <TouchableOpacity style={globalStyles.evBookSlotBtn} onPress={() => setSelected('')}>
                                    ...
                                    <ScrollView contentContainerStyle={globalStyles.homeScrollView} showsVerticalScrollIndicator={false}>
                                        ...
                                        <View style={globalStyles.electricMainView}>
                                            ...
                                            <DropShadow
                                                style={globalStyles.shadowView}
                                            >
                                                <View style={{ flexDirection: 'row', width: Width(218), height: Height(30), backgroundColor: 'white', borderRadius: Width(10), justifyContent: 'center', alignItems: 'center' }}>
                                                    <BatteryComponent width={Width(21)} height={Height(14)} />
                                                    <Text style={globalStyles.electricText}>₹750 to ₹3550</Text>
                                                    <Ionicons name='information-circle-outline' style={{ marginLeft: Width(20) }} size={Height(15)} />
                                                </View>
                ...
                <View style={styles.page}>
                    ...
                    <View style={globalStyles.bookSlotMainView}>
                        ...
                        <TouchableOpacity style={globalStyles.confirmModalBookSlotBtn} onPress={() => setBookSlot(!bookSlot)}>
                            <Text style={globalStyles.confirmModalBtnText}>Book Battery</Text>
                        </TouchableOpacity>
                    </View>
                            ...
                            <View style={styles.centeredView}>
                                <View style={[styles.modalView, { height: Height(446), width: Width(330) }]}>
                                    ...
                                    <View style={globalStyles.confirmModalSubView}>
                                        <Text style={globalStyles.confirmModalFirstText}>Vehicle(EV)</Text>
                                        <Text style={globalStyles.confirmModalSecondText}>Tata Tigor EV</Text>
                                    </View>
                                    <View style={globalStyles.modalLine} />
                                    <View style={globalStyles.confirmModalSubView}>
                                        <Text style={globalStyles.confirmModalFirstText}>Vehicle Number</Text>
                                    ...
                                    <View style={globalStyles.modalLine} />
                                    <View style={globalStyles.confirmModalSubView}>
                                        <Text style={globalStyles.confirmModalFirstText}>Charging Point</Text>
                        ...
                        <ScrollView>
                            {
                                data1.map((item, i) => {
                                    return (
                                        <View key={i} >
                                            <TouchableOpacity style={styles.btn} onPress={() => setSelected('BookBattery')}>
                                                ...
                                                <Ionicons name='bookmark' size={Height(28)} color='#0C9348' style={{ marginLeft: Width(30) }} />
                                            </TouchableOpacity>
